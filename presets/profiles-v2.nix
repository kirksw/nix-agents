...
# This is the recommended way to define profiles going forward.
...
#
# To adopt, replace `./presets/profiles.nix` with `./presets/profiles-v2.nix`
# in your module list. The old profiles.nix continues to work — flat names
# are treated as `default/<name>` during the migration window.
